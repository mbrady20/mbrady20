...
_exper2:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  13:	6a 01                	push   $0x1
  15:	68 b8 07 00 00       	push   $0x7b8
  1a:	e8 24 03 00 00       	call   343 <open>
    if(fd < 0) {
  1f:	83 c4 10             	add    $0x10,%esp
  22:	85 c0                	test   %eax,%eax
  24:	78 69                	js     8f <main+0x8f>
  ...
  2b:	68 dc 07 00 00       	push   $0x7dc
  30:	e8 0b 01 00 00       	call   140 <strlen>
  35:	83 c4 0c             	add    $0xc,%esp
  38:	50                   	push   %eax
  39:	68 dc 07 00 00       	push   $0x7dc
  3e:	53                   	push   %ebx
  3f:	e8 df 02 00 00       	call   323 <write>
  44:	c7 04 24 dc 07 00 00 	movl   $0x7dc,(%esp)
  4b:	89 c6                	mov    %eax,%esi
  4d:	e8 ee 00 00 00       	call   140 <strlen>
  52:	83 c4 10             	add    $0x10,%esp
  55:	39 c6                	cmp    %eax,%esi
  57:	74 17                	je     70 <main+0x70>
        printf(1, "Failed to write to file %s\n", filename);
  59:	52                   	push   %edx
  5a:	68 b8 07 00 00       	push   $0x7b8
  5f:	68 ea 07 00 00       	push   $0x7ea
  64:	6a 01                	push   $0x1
  66:	e8 25 04 00 00       	call   490 <printf>
        exit();
  6b:	e8 93 02 00 00       	call   303 <exit>
    }

    printf(1, "Successfully wrote to file %s\n", filename);
  70:	50                   	push   %eax
  71:	68 b8 07 00 00       	push   $0x7b8
  76:	68 08 08 00 00       	push   $0x808
  7b:	6a 01                	push   $0x1
  7d:	e8 0e 04 00 00       	call   490 <printf>

    close(fd);
  82:	89 1c 24             	mov    %ebx,(%esp)
  85:	e8 a1 02 00 00       	call   32b <close>

    exit();
  8a:	e8 74 02 00 00       	call   303 <exit>
        printf(1, "Failed to open file %s\n", filename);
  8f:	51                   	push   %ecx
  90:	68 b8 07 00 00       	push   $0x7b8
  95:	68 c4 07 00 00       	push   $0x7c4
  9a:	6a 01                	push   $0x1
...
000003c3 <getpgdirinfo>:
SYSCALL(getpgdirinfo)
 3c3:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3c8:	cd 40                	int    $0x40
 3ca:	c3                   	ret    

000003cb <getwmapinfo>:
SYSCALL(getwmapinfo)
 3cb:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3d0:	cd 40                	int    $0x40
 3d2:	c3                   	ret    
...
00000490 <printf>:
 ...
 509:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
 ...
 617:	90                   	nop
 618:	ba 27 08 00 00       	mov    $0x827,%edx
