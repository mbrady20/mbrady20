 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba b8 07 00 00       	mov    $0x7b8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 c4 0a 00 00    	mov    %edx,0xac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf c8 0a 00 00       	mov    $0xac8,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 772:	00 00 00 
    if(p->s.size >= nunits){
