...
_testwmap:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  addr = wmap(addr, length, flags, fd);
   f:	6a ff                	push   $0xffffffff
  11:	6a 0e                	push   $0xe
  13:	68 00 20 00 00       	push   $0x2000
  18:	68 00 00 00 60       	push   $0x60000000
  1d:	e8 69 03 00 00       	call   38b <wmap>
  ...
  2e:	66 90                	xchg   %ax,%ax
    ptr[i] = i % 256;
  30:	88 14 02             	mov    %dl,(%edx,%eax,1)
  for(int i = 0; i < length; i++)
  33:	83 c2 01             	add    $0x1,%edx
  36:	81 fa 00 20 00 00    	cmp    $0x2000,%edx
  3c:	75 f2                	jne    30 <main+0x30>

  // Read from the mapped memory and check the values
  for(int i = 0; i < length; i++){
  3e:	31 d2                	xor    %edx,%edx
  40:	eb 11                	jmp    53 <main+0x53>
  42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  48:	83 c2 01             	add    $0x1,%edx
  4b:	81 fa 00 20 00 00    	cmp    $0x2000,%edx
  51:	74 20                	je     73 <main+0x73>
    if(ptr[i] != i % 256){
  53:	0f be 1c 02          	movsbl (%edx,%eax,1),%ebx
  57:	0f b6 ca             	movzbl %dl,%ecx
  5a:	39 cb                	cmp    %ecx,%ebx
  5c:	74 ea                	je     48 <main+0x48>
      printf(1, "memory check failed at %d\n", i);
  5e:	83 ec 04             	sub    $0x4,%esp
  61:	52                   	push   %edx
  62:	68 98 07 00 00       	push   $0x798
  67:	6a 01                	push   $0x1
  69:	e8 02 04 00 00       	call   470 <printf>
      exit();
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 d0 07 00 00 	jmp    *0x7d0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba c8 07 00 00       	mov    $0x7c8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 d4 0a 00 00    	mov    %edx,0xad4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf d8 0a 00 00       	mov    $0xad8,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 782:	00 00 00 
    if(p->s.size >= nunits){
