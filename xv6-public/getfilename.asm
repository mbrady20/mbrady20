...
_getfilename:     file format elf32-i386
...
int main(int argc, char *argv[]) {
   ...
   e:	51                   	push   %ecx
    ...
    char message[256] = {"\0"};
   f:	8d bd fc fe ff ff    	lea    -0x104(%ebp),%edi
int main(int argc, char *argv[]) {
  15:	81 ec 08 01 00 00    	sub    $0x108,%esp
  1b:	8b 41 04             	mov    0x4(%ecx),%eax
    int fileID = open(argv[1], 256);
  1e:	68 00 01 00 00       	push   $0x100
  23:	ff 70 04             	push   0x4(%eax)
  26:	e8 d8 02 00 00       	call   303 <open>
    char message[256] = {"\0"};
  2b:	b9 3f 00 00 00       	mov    $0x3f,%ecx
    getfilename(fileID, message, 256);
  30:	83 c4 0c             	add    $0xc,%esp
    char message[256] = {"\0"};
  33:	c7 85 f8 fe ff ff 00 	movl   $0x0,-0x108(%ebp)
  3a:	00 00 00 
    int fileID = open(argv[1], 256);
  3d:	89 c2                	mov    %eax,%edx
    char message[256] = {"\0"};
  3f:	31 c0                	xor    %eax,%eax
  41:	f3 ab                	rep stos %eax,%es:(%edi)
    getfilename(fileID, message, 256);
  43:	8d bd f8 fe ff ff    	lea    -0x108(%ebp),%edi
  49:	68 00 01 00 00       	push   $0x100
  4e:	57                   	push   %edi
  4f:	52                   	push   %edx
  50:	e8 0e 03 00 00       	call   363 <getfilename>
    //int **pf;
    //if (argfd(1, &pfd, &pf) == -1) {
    // return -1;
    //}
  ...
  58:	57                   	push   %edi
  59:	68 48 07 00 00       	push   $0x748
  5e:	6a 01                	push   $0x1
  60:	e8 bb 03 00 00       	call   420 <printf>
        message);
    exit();
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 6b 07 00 00       	mov    $0x76b,%edx
        while(*s != 0){
 ...
 5c1:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 78 0a 00 00    	mov    %edx,0xa78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf 7c 0a 00 00       	mov    $0xa7c,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 732:	00 00 00 
    if(p->s.size >= nunits){
