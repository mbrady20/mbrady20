 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 94 07 00 00 	jmp    *0x794(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 8b 07 00 00       	mov    $0x78b,%edx
        while(*s != 0){
 ...
 5e1:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 98 0a 00 00    	mov    %edx,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 752:	00 00 00 
    if(p->s.size >= nunits){
