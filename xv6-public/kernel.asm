...
80104228:	8b 14 85 cc 78 10 80 	mov    -0x7fef8734(,%eax,4),%edx
      state = "???";
...
801042ea:	68 e4 78 10 80       	push   $0x801078e4
...
80104525:	68 ef 78 10 80       	push   $0x801078ef
8010452a:	e8 51 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010452f:	83 ec 0c             	sub    $0xc,%esp
80104532:	68 06 79 10 80       	push   $0x80107906
...
8010459b:	68 0d 79 10 80       	push   $0x8010790d
...
80104690:	68 15 79 10 80       	push   $0x80107915
...
80104abc:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104ae8:	68 1d 79 10 80       	push   $0x8010791d
...
80104c44:	68 b8 79 10 80       	push   $0x801079b8
...
80104c5c:	68 b7 79 10 80       	push   $0x801079b7
...
80104c71:	68 ab 79 10 80       	push   $0x801079ab
...
80104c8f:	68 ba 79 10 80       	push   $0x801079ba
80104c94:	e8 e7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c99:	83 ec 0c             	sub    $0xc,%esp
80104c9c:	68 9c 79 10 80       	push   $0x8010799c
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 b8 79 10 80       	push   $0x801079b8
...
801050b8:	68 b7 79 10 80       	push   $0x801079b7
...
801056f4:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
801056f5:	8d 75 f4             	lea    -0xc(%ebp),%esi
{
801056f8:	83 ec 18             	sub    $0x18,%esp
  ...
  char * buf = {"\0"};
801056fb:	c7 45 f0 fd 79 10 80 	movl   $0x801079fd,-0x10(%ebp)
  if(argint(n, &fd) < 0)
80105702:	56                   	push   %esi
80105703:	6a 00                	push   $0x0
80105705:	e8 56 f2 ff ff       	call   80104960 <argint>
8010570a:	83 c4 10             	add    $0x10,%esp
8010570d:	85 c0                	test   %eax,%eax
8010570f:	78 67                	js     80105778 <sys_getfilename+0x88>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80105711:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105715:	77 61                	ja     80105778 <sys_getfilename+0x88>
80105717:	e8 54 e2 ff ff       	call   80103970 <myproc>
8010571c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010571f:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80105723:	85 c9                	test   %ecx,%ecx
80105725:	74 51                	je     80105778 <sys_getfilename+0x88>
...
8010573d:	e8 de f2 ff ff       	call   80104a20 <argstr>
80105742:	83 c4 10             	add    $0x10,%esp
80105745:	89 c3                	mov    %eax,%ebx
80105747:	85 c0                	test   %eax,%eax
80105749:	75 2d                	jne    80105778 <sys_getfilename+0x88>
    return -1;
  } 
  argint(2, &n);
...
80105751:	e8 0a f2 ff ff       	call   80104960 <argint>

  getfilename(fd, buf, n);
80105756:	83 c4 0c             	add    $0xc,%esp
80105759:	ff 75 f4             	push   -0xc(%ebp)
8010575c:	ff 75 f0             	push   -0x10(%ebp)
8010575f:	ff 75 ec             	push   -0x14(%ebp)
80105762:	e8 39 eb ff ff       	call   801042a0 <getfilename>
	return 0;
80105767:	83 c4 10             	add    $0x10,%esp
}
8010576a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010576d:	89 d8                	mov    %ebx,%eax
8010576f:	5b                   	pop    %ebx
80105770:	5e                   	pop    %esi
80105771:	5d                   	pop    %ebp
80105772:	c3                   	ret    
...
8010577d:	eb eb                	jmp    8010576a <sys_getfilename+0x7a>
8010577f:	90                   	nop
...
801057ac:	e8 af f1 ff ff       	call   80104960 <argint>
...
801057fd:	e8 5e f1 ff ff       	call   80104960 <argint>
...
8010584d:	e8 0e f1 ff ff       	call   80104960 <argint>
...
80105860:	68 20 3e 11 80       	push   $0x80113e20
80105865:	e8 76 ed ff ff       	call   801045e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010586a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010586d:	8b 1d 00 3e 11 80    	mov    0x80113e00,%ebx
  while(ticks - ticks0 < n){
...
80105883:	68 20 3e 11 80       	push   $0x80113e20
80105888:	68 00 3e 11 80       	push   $0x80113e00
8010588d:	e8 ae e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105892:	a1 00 3e 11 80       	mov    0x80113e00,%eax
...
801058b0:	68 20 3e 11 80       	push   $0x80113e20
801058b5:	e8 c6 ec ff ff       	call   80104580 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058d3:	68 20 3e 11 80       	push   $0x80113e20
801058d8:	e8 a3 ec ff ff       	call   80104580 <release>
  return 0;
...
801058f4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058f7:	68 20 3e 11 80       	push   $0x80113e20
801058fc:	e8 df ec ff ff       	call   801045e0 <acquire>
  xticks = ticks;
80105901:	8b 1d 00 3e 11 80    	mov    0x80113e00,%ebx
  release(&tickslock);
80105907:	c7 04 24 20 3e 11 80 	movl   $0x80113e20,(%esp)
8010590e:	e8 6d ec ff ff       	call   80104580 <release>
  return xticks;
}
...
80105957:	c7 04 c5 62 3e 11 80 	movl   $0x8e000008,-0x7feec19e(,%eax,8)
8010595e:	08 00 00 8e 
80105962:	66 89 14 c5 60 3e 11 	mov    %dx,-0x7feec1a0(,%eax,8)
80105969:	80 
8010596a:	c1 ea 10             	shr    $0x10,%edx
8010596d:	66 89 14 c5 66 3e 11 	mov    %dx,-0x7feec19a(,%eax,8)
80105974:	80 
  for(i = 0; i < 256; i++)
...
80105987:	c7 05 62 40 11 80 08 	movl   $0xef000008,0x80114062
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 ff 79 10 80       	push   $0x801079ff
80105996:	68 20 3e 11 80       	push   $0x80113e20
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010599b:	66 a3 60 40 11 80    	mov    %ax,0x80114060
801059a1:	c1 e8 10             	shr    $0x10,%eax
801059a4:	66 a3 66 40 11 80    	mov    %ax,0x80114066
  initlock(&tickslock, "time");
...
801059cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059cf:	b8 60 3e 11 80       	mov    $0x80113e60,%eax
...
80105c00:	68 20 3e 11 80       	push   $0x80113e20
80105c05:	e8 d6 e9 ff ff       	call   801045e0 <acquire>
      wakeup(&ticks);
80105c0a:	c7 04 24 00 3e 11 80 	movl   $0x80113e00,(%esp)
      ticks++;
80105c11:	83 05 00 3e 11 80 01 	addl   $0x1,0x80113e00
      wakeup(&ticks);
80105c18:	e8 e3 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105c1d:	c7 04 24 20 3e 11 80 	movl   $0x80113e20,(%esp)
80105c24:	e8 57 e9 ff ff       	call   80104580 <release>
...
80105c70:	68 04 7a 10 80       	push   $0x80107a04
...
{
  if(!uart)
80105c80:	a1 60 46 11 80       	mov    0x80114660,%eax
...
80105d07:	74 78                	je     80105d81 <uartinit+0xd1>
  uart = 1;
80105d09:	c7 05 60 46 11 80 01 	movl   $0x1,0x80114660
80105d10:	00 00 00 
...
80105d39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105d40:	a1 60 46 11 80       	mov    0x80114660,%eax
...
80105d90 <uartputc>:
  if(!uart)
80105d90:	a1 60 46 11 80       	mov    0x80114660,%eax
...
801069c5:	e8 d6 dc ff ff       	call   801046a0 <memset>
...
80106a3a:	c7 80 b8 19 11 80 ff 	movl   $0xffff,-0x7feee648(%eax)
80106a41:	ff 00 00 
80106a44:	c7 80 bc 19 11 80 00 	movl   $0xcf9a00,-0x7feee644(%eax)
80106a4b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a4e:	c7 80 c0 19 11 80 ff 	movl   $0xffff,-0x7feee640(%eax)
80106a55:	ff 00 00 
80106a58:	c7 80 c4 19 11 80 00 	movl   $0xcf9200,-0x7feee63c(%eax)
80106a5f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a62:	c7 80 c8 19 11 80 ff 	movl   $0xffff,-0x7feee638(%eax)
80106a69:	ff 00 00 
80106a6c:	c7 80 cc 19 11 80 00 	movl   $0xcffa00,-0x7feee634(%eax)
80106a73:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a76:	c7 80 d0 19 11 80 ff 	movl   $0xffff,-0x7feee630(%eax)
80106a7d:	ff 00 00 
80106a80:	c7 80 d4 19 11 80 00 	movl   $0xcff200,-0x7feee62c(%eax)
80106a87:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a8a:	05 b0 19 11 80       	add    $0x801119b0,%eax
  pd[1] = (uint)p;
...
80106ab0:	a1 64 46 11 80       	mov    0x80114664,%eax
...
80106ae4:	0f 84 c2 00 00 00    	je     80106bac <switchuvm+0xec>
  pushcli();
80106aea:	e8 a1 d9 ff ff       	call   80104490 <pushcli>
...
80106b99:	5d                   	pop    %ebp
  popcli();
80106b9a:	e9 41 d9 ff ff       	jmp    801044e0 <popcli>
...
80106bff:	e8 9c da ff ff       	call   801046a0 <memset>
...
80106c32:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c33:	e9 08 db ff ff       	jmp    80104740 <memmove>
...
80106d8b:	e8 10 d9 ff ff       	call   801046a0 <memset>
...
80106f40:	e8 5b d7 ff ff       	call   801046a0 <memset>
...
80106fab:	a3 64 46 11 80       	mov    %eax,0x80114664
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070b0:	e8 8b d6 ff ff       	call   80104740 <memmove>
...
801071e0:	e8 5b d5 ff ff       	call   80104740 <memmove>
    len -= n;
    buf += n;
